                    ...
                    function o() {
                        ...
                        for (b.length = 0, t = 0; t < S.length; ++t) {
                            ...
                            if (
                                ...
                                var N = v.join(" ");
                                -1 === N.indexOf("NaN") &&
                                    setAttribute(p, "points", N),
                                    b.push(o);
                            }
                        }
                        for (
                            b.sort(i), y.innerHTML = "", t = 0;
                            t < b.length;
                            ++t
                        )
                            ...
                            return function () {
                                ...
                                if (
                                    ...
                                    rotate(
                                        r,
                                        r,
                                        0.1 + 0.2 * Math.sin(m / 3),
                                        s
                                    ),
                                        rotate(
                                            r,
                                            r,
                                            0.03 * Math.sin(m / 2) - 0.1,
                                            h
                                        ),
                                        rotate(
                                            r,
                                            r,
                                            0.5 + 0.2 * Math.sin(m / 3),
                                            f
                                        );
                                }
